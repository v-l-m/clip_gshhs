...
|_   _(_) | ___  ___ / ___| ___ _ __   ___ _ __ __ _| |_ ___  _ __ \n \
  ...
  |_| |_|_|\\___||___/\\____|\\___|_| |_|\\___|_|  \\__,_|\\__\\___/|_|   \n \
                Tiles Generator V1.0 - 15/03/2012 \n \
                       stephpen@gmail.com\n\n"
...
int main (int argc, char **argv)
{
        ...
        switch (next_option)
        {
            ...
            case 'n':
                if (optarg)
                {
                    ...
                    // test si nb_tiles est pair ou impair, uniquement les nombres pair sont acceptes
    ...
    //Determination des longitudes mini, maxi, et origine image x
    ...
    //Determination des latitudes mini, maxi, et origine image y
        ...
        else
        {
            ...
            if (long_min_int>=0 && long_max_int<=360)
            {
                for (x=long_min_int; x<long_max_int; x=x+PolyHeader.pasx)
                {
                    for (y=lat_min_int; y<lat_max_int; y=y+PolyHeader.pasy)
                    {
                        ReadPolygonFile(PolyFile, x, y, PolyHeader.pasx, PolyHeader.pasy, &p1, &p2, &p3, &p4);
